export const SCANNER_TEXT_WHITELIST = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-/ ';
...
const GUNDAM_CARD_BOUND_TEMPLATES = [
  ...
  { widthRatio: 0.32, centerX: 0.5, centerY: 0.55 },
  { widthRatio: 0.28, centerX: 0.5, centerY: 0.56 },
...
export const SCANNER_PROFILES = {
  gundam: {
    ...
    guide: 'Gundam: acerca la esquina superior derecha hasta ver nitido el codigo',
    cardFrameRatio: DEFAULT_CARD_FRAME_RATIO,
    cardBoundTemplates: GUNDAM_CARD_BOUND_TEMPLATES,
    maxCodeRegions: 22,
    maxNameRegions: 0,
    maxCardBoundsForRegions: 7,
    maxCodeAttempts: 34,
    requireCodeForAutoResolve: true,
    skipNameFallbackWhenCodeRequired: true,
    ...
    fullFrameRegions: [
      { label: 'imagen esquina codigo cercana', x: 0.61, y: 0.01, width: 0.34, height: 0.10, scale: 4.8, priority: 0.46 },
      { label: 'imagen esquina codigo estrecha', x: 0.68, y: 0.01, width: 0.27, height: 0.08, scale: 5.2, priority: 0.44 },
      { label: 'imagen protector rigido codigo', x: 0.58, y: 0.16, width: 0.34, height: 0.11, scale: 4.6, priority: 0.50 },
      { label: 'imagen carta pequena superior derecha', x: 0.45, y: 0.20, width: 0.38, height: 0.15, scale: 3.8, priority: 0.50 },
      { label: 'imagen tercio superior derecho', x: 0.48, y: 0.14, width: 0.44, height: 0.24, scale: 2.3, priority: 0.42 },
      { label: 'imagen superior central derecha', x: 0.34, y: 0.18, width: 0.50, height: 0.20, scale: 2.2, priority: 0.4 },
      { label: 'imagen superior derecha', x: 0.42, y: 0.02, width: 0.56, height: 0.18, scale: 2.2, priority: 0.36 },
      { label: 'imagen superior completa', x: 0.08, y: 0.02, width: 0.90, height: 0.20, scale: 1.8, priority: 0.28 },
      { label: 'imagen centro superior derecha', x: 0.44, y: 0.10, width: 0.54, height: 0.24, scale: 2, priority: 0.4 },
      { label: 'imagen inferior completa', x: 0.06, y: 0.72, width: 0.90, height: 0.24, scale: 1.8 },
    ],
    regions: [
      { label: 'codigo esquina superior derecha micro', x: 0.70, y: 0.00, width: 0.28, height: 0.062, scale: 7.2, priority: 1 },
      { label: 'codigo esquina superior derecha fino', x: 0.64, y: 0.00, width: 0.34, height: 0.075, scale: 6.8, priority: 0.98 },
      { label: 'codigo pestana superior derecha', x: 0.58, y: 0.00, width: 0.40, height: 0.090, scale: 6.2, priority: 0.95 },
      { label: 'codigo pestana superior baja', x: 0.58, y: 0.022, width: 0.40, height: 0.090, scale: 6.0, priority: 0.90 },
      { label: 'codigo superior derecho respaldo', x: 0.50, y: 0.00, width: 0.48, height: 0.115, scale: 5.5, priority: 0.82 },
      { label: 'codigo superior derecho completo', x: 0.42, y: 0.00, width: 0.56, height: 0.145, scale: 4.8, priority: 0.70 },
      { label: 'cabecera derecha', x: 0.34, y: 0.00, width: 0.64, height: 0.15, scale: 4.0, priority: 0.58 },
      { label: 'cabecera alta', x: 0.00, y: 0.00, width: 1.00, height: 0.20, scale: 3.1, priority: 0.48 },
      { label: 'codigo lateral derecho', x: 0.82, y: 0.08, width: 0.17, height: 0.62, scale: 3.8, priority: 0.45 },
      { label: 'codigo inferior completo', x: 0.03, y: 0.76, width: 0.94, height: 0.2, scale: 3.8, priority: 0.38 },
      { label: 'codigo inferior izquierdo', x: 0.02, y: 0.78, width: 0.5, height: 0.18, scale: 4.2, priority: 0.36 },
      { label: 'codigo inferior derecho', x: 0.48, y: 0.78, width: 0.5, height: 0.18, scale: 4.2, priority: 0.36 },
    ],
  },
  'one-piece': {
    slug: 'one-piece',
