...
export const SCANNER_PROFILES = {
  gundam: {
    ...
    fullFrameRegions: [
      { label: 'imagen esquina codigo cercana', x: 0.58, y: 0.01, width: 0.38, height: 0.13, scale: 3.5, priority: 0.34 },
      { label: 'imagen esquina codigo estrecha', x: 0.66, y: 0.01, width: 0.30, height: 0.10, scale: 4, priority: 0.32 },
      { label: 'imagen protector rigido codigo', x: 0.56, y: 0.16, width: 0.36, height: 0.13, scale: 3.4, priority: 0.46 },
      { label: 'imagen carta pequena superior derecha', x: 0.42, y: 0.20, width: 0.42, height: 0.18, scale: 3.1, priority: 0.48 },
      { label: 'imagen carta pequena nombre', x: 0.30, y: 0.46, width: 0.46, height: 0.18, scale: 2.7, mode: 'name' },
